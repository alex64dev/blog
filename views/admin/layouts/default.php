    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?= $router->generate_url('admin_dashboard') ?>">Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $router->generate_url('admin_posts') ?>">Posts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $router->generate_url('admin_categories') ?>">Catégories</a>
                </li>
            </ul>
        </div>
